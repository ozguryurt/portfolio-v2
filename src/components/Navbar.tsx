        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              className={`min-h-11 rounded-xl px-1 py-3 text-center text-[11px] font-semibold leading-none transition-colors sm:min-h-0 sm:rounded-full sm:px-3 sm:py-2 sm:text-base ${
                isActive
