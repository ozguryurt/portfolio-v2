        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    >
                        <div
                            className="mx-2 sm:mx-4 md:mx-6 lg:mx-10 w-auto dark:bg-zinc-900 bg-white rounded-t-2xl shadow-2xl border-t border-zinc-200 dark:border-zinc-800 h-[calc(100vh-2rem)] md:h-[75vh] flex flex-col"
